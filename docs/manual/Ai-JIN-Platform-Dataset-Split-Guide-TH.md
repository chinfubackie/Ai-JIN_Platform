...
> **ข้อสำคัญ:** การแบ่งชุดข้อมูลที่ดีไม่ทดแทน annotation ปัจจุบันมี label 5 ไฟล์จาก 1,249 ภาพ และทั้งหมดอยู่ใน Test จึงยังไม่พร้อมสำหรับการฝึกโมเดลจริง
...
หน้า Import รองรับ viewport แคบ เมนูหลักและเมนูจาก sidebar แสดงครบแบบ 4 คอลัมน์ 3 แถวโดยไม่ต้องเลื่อนแนวนอน และเนื้อหาหลักใช้เต็มความกว้าง
